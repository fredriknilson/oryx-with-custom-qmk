...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_0,           KC_1,           KC_2,           KC_3,           KC_4,                                           KC_5,           KC_6,           KC_7,           KC_8,           KC_9,           TD(DANCE_0),    
...
const uint16_t PROGMEM combo0[] = { KC_G, KC_1, COMBO_END};
const uint16_t PROGMEM combo1[] = { KC_G, KC_2, COMBO_END};
