...
#define DUAL_FUNC_2 LT(14, KC_F23)
#define DUAL_FUNC_3 LT(9, KC_2)
#define DUAL_FUNC_4 LT(13, KC_F11)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, DUAL_FUNC_2,    DUAL_FUNC_3,    KC_BSLS,        KC_UNDS,        KC_PERC,                                        KC_AT,          KC_LBRC,        KC_RBRC,        DUAL_FUNC_4,    MT(MOD_RALT, KC_QUOTE),KC_TRANSPARENT, 
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_LEFT_ALT,    KC_LEFT_GUI,    KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          LGUI(KC_LBRC),  LGUI(KC_RBRC),  KC_RIGHT_GUI,   KC_RIGHT_ALT,   KC_TRANSPARENT, 
