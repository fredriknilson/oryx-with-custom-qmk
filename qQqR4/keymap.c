...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TAB,         KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,                                           KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           RALT(KC_W),     
    KC_LEFT_CTRL,   KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                           KC_H,           KC_J,           KC_K,           KC_L,           RALT(KC_O),     RALT(KC_A),     
    KC_LEFT_SHIFT,  KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_QUES,        KC_RIGHT_ALT,   
                                                    KC_SPACE,       KC_LEFT_ALT,                                    LT(2, KC_ENTER),LT(3, KC_BSPC)
  ),
  [2] = LAYOUT_voyager(
  ...
  [3] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, DUAL_FUNC_2,    DUAL_FUNC_3,    LGUI(KC_C),     LGUI(KC_V),     KC_NO,                                          KC_NO,          LGUI(KC_LBRC),  KC_NO,          LGUI(KC_RBRC),  KC_NO,          KC_TRANSPARENT, 
