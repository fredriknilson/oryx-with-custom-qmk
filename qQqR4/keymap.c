...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_LEFT_CTRL,   KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_QUES,        KC_RIGHT_ALT,   
                                                    KC_LEFT_ALT,    KC_SPACE,                                       LT(2, KC_ENTER),LT(3, KC_BSPC)
  ),
  [2] = LAYOUT_voyager(
