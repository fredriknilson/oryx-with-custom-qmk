...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_LEFT_SHIFT,  DUAL_FUNC_4,    DUAL_FUNC_5,    MT(MOD_LALT, KC_SLASH),MT(MOD_LGUI, KC_EQUAL),KC_AMPR,                                        KC_HASH,        DUAL_FUNC_8,    DUAL_FUNC_9,    MT(MOD_RCTL, KC_SCLN),DUAL_FUNC_10,   KC_NO,          
    KC_LEFT_CTRL,   DUAL_FUNC_6,    DUAL_FUNC_7,    KC_BSLS,        KC_UNDS,        KC_PERC,                                        KC_AT,          KC_LBRC,        KC_RBRC,        KC_DOT,         KC_QUOTE,       KC_NO,          
